...
namespace programa
{
    static class FuncionesUtiles
    {
        static void Main(string[] args)
        {
            //int[,] numeros = CrearMatrizdividido(4, 4);
            ...
            int numeromenor= menor(numeros.GetLength(0),numeros.GetLength(1));
            for(int i = 0; i < numeromenor ; i++){
                numeros[i,i]= 99;
            }
            ImprimirMatriz(numeros);*/

            int[,] llenar = LlenarMatrizA(4,4);
            ImprimirMatriz(llenar);
        ...
        static int menor(int num1, int num2) // sacar el mayor de dos numeros
        {
            if (num1 < num2)
            {
                return num1;
        ...
        static int[,] LlenarMatrizA(int filas, int columnas)
        {
...

            {
                 for (int fila = 0; fila < filas; fila++)
                {
                    matriz[fila, columna]=contador; // Llenar la matriz con números del 1 al número de columnas
                    contador++;
                }
            }
        ...
        static void MostrarMatriz<T>(T[,] matriz)
        {
            for (int fila = 0; fila < matriz.GetLength(1); fila++)
            {
